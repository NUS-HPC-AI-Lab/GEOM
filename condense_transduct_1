...
log_dir = './' + args.save_log + '/Distill/norm-2-val-kd2-lr_y{}-{}-reduce_{}-lam-{}-T-{}-scheduler-{}-min{}-max{}-syn_steps{}-expert_epochs{}-lr_feat{}-current_max_start_epoch{}'.format(args.lr_y,args.dataset, str(args.reduction_rate),args.lam,args.T,args.scheduler
